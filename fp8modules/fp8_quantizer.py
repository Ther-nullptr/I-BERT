...
if __name__ == '__main__':
    print(f'E4M3 NVIDIA, {get_max_value(num_total_bits = 8, bias = 7, use_ieee_standard=False)}')
    print(generate_all_values_fp(num_total_bits = 8, bias = 7, use_ieee_standard=False)) # E4M3 NVIDIA
    print(f'E4M3 IEEE, {get_max_value(num_total_bits = 8, bias = 7, use_ieee_standard=True)}')
    print(generate_all_values_fp(num_total_bits = 8, bias = 7, use_ieee_standard=True))
    print(f'E5M2 IEEE, {get_max_value(num_total_bits = 8, num_exponent_bits = 5, bias = 15, use_ieee_standard=True)}')
    print(generate_all_values_fp(num_total_bits = 8, num_exponent_bits = 5, bias = 15, use_ieee_standard=True)) # E5M2